...
import { rec_channels,top_channels } from '../data';
...
const Sidemenu = () => {
  ...
  return(
    <div className=" negativeM w-14 sm:w-16 xl:w-[15rem]  p-2 bg-[#0e0e10]">
...

        {
           rec_channels.map((item,index) => (
              <div key={index} className="inline-flex items-center w-full py-[2x]">
