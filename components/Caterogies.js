...
import CategoriesItem from './CaterogiesItems'
...
export default function Caterogies() {
  return (
    <div id="live" className="p-2 md:p-8">
        ...
        <span className="text-[#9147ff]">Top Categories</span> we think you will like
        
        </h2>

        <div className="grid grid-cols-2 sm:grid-cols-3  md:grid-cols-4 lg:grid-cols-5 2xl:grid-cols10 gap-2 py-20" >
        <CategoriesItem
